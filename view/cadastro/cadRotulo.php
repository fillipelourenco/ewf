<?
	...
	//action
	require_once '../../control/action/RotuloAction.php';
	...
	$updRotulo = $rotuloController->get();
				...
				<h3>Rótulos</h3>
                    <fieldset style="width:870px;">
                        ...
                        <form action="<? $PHP_SELF; ?>" method="post">
                            ...
                            <input name="nome" id="nome" size="45" value="<? echo $updRotulo['nome']; ?>" type="text" /></p>
												
							<p style="margin-top:25px;">
							<input name="BTNew" class="formbutton" value="<? if ($_SESSION["upd_rotulo"]) echo "Atualizar"; else echo "Cadastrar"; ?>" type="submit" />
