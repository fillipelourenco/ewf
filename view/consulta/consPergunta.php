<?
	...
	$perguntas = $perguntaController->listAll();
...
<div id="conteudo" class="column">
	<h3><?=$_SESSION['nome_projeto_logado']?> / Perguntas - <?=$_SESSION['chave_formulario']?></h3>
	<fieldset style="width:870px;">
		<legend></legend>
		<form action="" method="post">
		<table cellpading="0" cellspacing="5" border="0">
			<tbody>
			<?=$perguntaController->printConsulta($perguntas)?>
		</table>
		<div id="coluna-1" style="width:870px;padding: 0px;">
		<input name="BTBack" class="formbutton" value="Voltar" type="submit" />
		<input name="BTNova" class="formbutton" value="Nova" type="submit" />
		</div>	
		<p>
		</form>
	</fieldset>
