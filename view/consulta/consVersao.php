<?
	...
	$versoes = $versaoController->listAll();
...
<div id="conteudo" class="column">
	...
	<fieldset style="width:870px;">
		...
		<table cellpading="0" cellspacing="5" border="0">
			<? echo '<p style="font-family:\'Lucida Grande\',\'Lucida Sans Unicode\',Geneva,Verdana,Sans-Serif;font-size:14px;">Versão Atual: '.$lastVersao->master_version.'.'.$lastVersao->great_version.'.'.$lastVersao->average_version.'.'.$lastVersao->small_version; ?>
			<tbody>
			<?=$versaoController->printConsulta($versoes)?>
		</table>
		<? if ($_SESSION['tipo_usuario_logado'] == '1') : ?>
