<?
	...
	$usuarios = $permissaoController->loadPermissoes();
			...
			<legend></legend>
				<form action="<? $PHP_SELF; ?>" method="post">
					<table cellpading="0" cellspacing="5" border="0">
						<tbody>
						<?=$permissaoController->printConsulta($usuarios)?>
					</table>
					<div id="coluna-1" style="width:900px;padding: 0px;">
						<p><input name="BTNovo" class="formbutton" value="Adicionar" type="submit" /></p>
					</div>
                </form>
        </fieldset>
</div>
