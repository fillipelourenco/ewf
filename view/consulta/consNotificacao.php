<?
	...
	$notificacoes = $notificacaoController->listAll();
...
<div id="conteudo" class="column">
	...
	<fieldset style="width:870px;">
		<legend></legend>
		<form action="../../control/action/NotificacaoAction.php" method="post">
		<table cellpading="0" cellspacing="5" border="0">
			<tbody>
			<?=$notificacaoController->printConsulta($notificacoes)?>
		</table>
