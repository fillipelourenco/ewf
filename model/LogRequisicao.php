<?php
class LogRequisicao extends Lumine_Base{
    protected $_tablename = 'logs_requisicoes';
    protected $_package   = 'model';
    protected function _initialize() {
        $this->_addField('id_log_requisicao', 'id_log_requisicao', 'tinyint', 4, array('primary' => true, 'notnull' => true, 'autoincrement' => true));
