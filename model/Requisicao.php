...
class Requisicao extends Lumine_Base{
    ...
    protected function _initialize() {
		...
		$this->_addField('prioridade', 'prioridade', 'text', null, array());
		...
		$this->_addField("id_usuario_solicitante", "id_usuario_solicitante", "int", 10, array('notnull' => true, 'foreign' => '1', 'onUpdate' => 'CASCADE', 'onDelete' => 'CASCADE', 'linkOn' => 'id_usuario', 'class' => 'Usuario'));
